...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_stylis_rule_sheet__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_prop_types__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react_is__ = __webpack_require__(140);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1), __webpack_require__(143)(module)))
...
var _styledComponents = __webpack_require__(127);
...
var Heading = _styledComponents2.default.div(_templateObject);
...
var Item = _styledComponents2.default.li(_templateObject5);

var Day = _styledComponents2.default.li(_templateObject6);

var Number = _styledComponents2.default.text(_templateObject7);

var DayDate = function (_Component) {
  _inherits(DayDate, _Component);

  function DayDate(props) {
    _classCallCheck(this, DayDate);

    var _this = _possibleConstructorReturn(this, (DayDate.__proto__ || Object.getPrototypeOf(DayDate)).call(this, props));

    _this.state = {};
    return _this;
  }

  _createClass(DayDate, [{
    key: 'handleClick',
...
var Calendar = function (_Component2) {
  ...
  _createClass(Calendar, [{
    ...
    key: 'getMonthName',
    value: function getMonthName(num) {
      return (0, _moment2.default)().month(num).format('MMMM');
    }
  }, {
    key: 'createCalendar',
    value: function createCalendar(num) {
      var weeks = [];
      var day = 1;
      var startWeek = [];
      for (var i = 0; i < num; i++) {
    ...
    key: 'createMomentDate',
    value: function createMomentDate(value) {
      ...
      return (0, _moment2.default)(output, 'YYYY-MM-DD');
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      console.log((0, _moment2.default)().weekday(0).date());
      return _react2.default.createElement(
        CalendarWrapper,
        null,
        _react2.default.createElement(
          ...
          layout.map(function (week) {
            return _react2.default.createElement(
              ...
              week.map(function (item) {
                return _react2.default.createElement(DayDate, { day: item,
